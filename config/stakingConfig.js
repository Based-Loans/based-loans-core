...
const rinkebyConfig = {
  BLOETHPool: {
    ...
    rewardTokenAddress: null, // Set here or get BLO address from deployed contracts
  ...
  BLOWBTCPool: {
    ...
    rewardTokenAddress: null, // Set custom reward token address or get BLO address from deployed contracts
    duration: 3 * 30 * 24 * 3600, // For 3 months
    rewardAmount: '1000000' + '000000000000000000', // One million tokens
    startTime: 	1617026400, // From 2021-03-31:00:00:00 UTC
    fairDistribution: false,
